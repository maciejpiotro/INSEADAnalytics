...
##### Answers:
<br>
1. It is possible to identify pairs/groups of questions with highly correlated answers. Example: Question Q1_3 and Q1_9 have correlation of 0.58. This is because people for whom boat is a status symbol would score high on both questions. 
<br>
Q1_3: The brand of boat I buy says a lot about who I am
<br>
Q1_9: I see my boat as a status symbol
<br>
<br>
2. These correlations imply that it is possible to group some questions togther as they are reflecting a common trait (component). Such approach would allow to reduce complexitiy of data (dimentionality reduction technique) and jence would facilitate further data analysis. 
<hr>
...
<br>
1.
The table is an output of PCA (Principal Component Analysis). It shows variance explained by individual Components as well as their eigenvalues. 
The Scree plot displayes eigenvalues of components (in descending order of eigenvalues). It can be used to determine optimal number of components to be used for firther analysis. 
<br>
2. 
The line cannot be increasing because the Components are sorted in the order of descending eigenvalue. The slope of the plot is flattening because eigenvalues of components are descreasing and approaching 0.
<br>
3.
The steeper the plot, the fewer components are required to explain variability in the data (i.e. higher explanatory power of compoenets). It can therefore reduce complexity of data analysis. 
<br>
...
<br>
1.
C1 - Status-seekers (need boat as a status symbol)
<br>
C2 - Fun and andventure-seekers (use boats for relaxing and socializing)
<br>
C3 - Technology and high-quality
<br>
C4 - Boat experts/geeks (knowledgable users)
<br>
C5 - Savvy customers (don't need frills, price sensitive)
<br>

The proposed 5 components make sense form business point of view. However for C4, 2 out of 3 factors also common with C1. This might suggest that the two segments overlap/are similar. Form business point of view it might make sense to merge these segments. 
 <br>
2.
From statistical point of view we should use 5 components (i.e. these with eigenvalues above 1). From interpretation point of view we hsould 5 or 4 components (4 components in case of merging C4 with C1). 
Business consideration suggest sticking to 5 components (all of them reflect different needs and therefore make business sense). 
<br>
3. Interpretation as in question 1 above
<br>
4. When performing statistical analysis one has to use business judgement and common-sense interpretation. While statistical analysis provides diverse tools, data scientists need to select tools suitable for a given case and apply them and then use judgement to confirm that interpretation of results make business sense. 
<hr>
<hr>
